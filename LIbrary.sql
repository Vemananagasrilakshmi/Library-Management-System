...
where
book_copies_BookID=(select book_BookID from tbl_book where book_Title='The Lost Tribe')
and
book_copies_BranchID=(select library_branch_BranchID from tbl_library_branch where library_branch_BranchName = 'Sharpstown'); */
SELECT
...
-- Which authors’ books are most frequently borrowed?
SELECT 
